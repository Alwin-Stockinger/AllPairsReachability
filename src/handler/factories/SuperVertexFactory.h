...
#ifndef ALLPAIRREACH_SUPERVERTEXFACTORY_H
#define ALLPAIRREACH_SUPERVERTEXFACTORY_H


#include "PartitionedFactory.h"

class SuperVertexFactory : public PartitionedFactory{
...
#endif //ALLPAIRREACH_SUPERVERTEXFACTORY_H
