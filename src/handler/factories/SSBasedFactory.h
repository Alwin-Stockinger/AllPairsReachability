...
#ifndef ALLPAIRREACH_SSBASEDFACTORY_H
#define ALLPAIRREACH_SSBASEDFACTORY_H


#include "AlgorithmFactory.h"

class SSBasedFactory : public AlgorithmFactory{
...
#endif //ALLPAIRREACH_SSBASEDFACTORY_H
